...
from simu.simulation.contract.incentive.prediction_market import PredictionMarket, PredictionMarketImModule
from simu.simulation.contract.objects import Msg
...
class Runner(object):
    ...
    def run(self):
        ...
        save_model = isinstance(
            self._im, PredictionMarket) and self._im.reset_model_during_reward_phase
